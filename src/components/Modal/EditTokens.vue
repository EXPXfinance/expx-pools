    ...
    <UiModalForm @submit="handleSubmit">
      ...
      <div v-if="step === 1" class="m-4 px-4 text-center">
        ...
        <ButtonUnlock
          ...
          :tokenAddress="pool.getEptAddress()"
          :amount="poolAmountIn"
          :decimals="18"
...
export default {
  ...
  methods: {
    ...
    async handleRemoveToken(tokenAddress, tokenWeight) {
      ...
      this.step = 1;
      const allowances = await this.getAllowances([this.pool.getEptAddress()]);
      this.allowance = parseInt(
        allowances[this.pool.getEptAddress()][this.web3.dsProxyAddress]
      );
    }
  }
};
